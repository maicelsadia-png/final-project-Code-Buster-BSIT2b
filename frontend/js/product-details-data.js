                ...
                <div class="col-lg-6">
                    <div class="product-info">
                        ...
                        <div class="product-stock">
                            <i class="fas fa-check-circle"></i> In Stock: ${product.stock || 0} units
                        </div>
                        ...
                        <div class="product-quantity">
                            ...
                            <div class="quantity-selector">
                                ...
                                <input type="number" id="quantity" name="quantity" value="1" min="1" max="${product.stock || 99}">
                        ...
                        <div class="product-meta mt-4">
                            ...
                            <p><strong>SKU:</strong> ${product.sku || product._id.slice(-6)}</p>
                        </div>
                    </div>
                </div>
            </div>
