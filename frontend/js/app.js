 ...
 * - Cart images now show for all products 1-8
 * - Product filters (sort by price/name) now works correctly
 * ========================================
 */
...
function renderCartPage() {
    ...
    if (cart.length === 0) {
        ...
        cart.forEach(item => {
            // ========================================
            // MAP PRODUCT ID TO ACTUAL IMAGE FILENAME (ALL 8 PRODUCTS)
            // ========================================
            ...
            else if (item.id == 5) productImage = 'Chocolate-Cake.jpg';
            else if (item.id == 6) productImage = 'French-Fries.jpg';
            else if (item.id == 7) productImage = 'Matcha-Latte.jpg';
            else if (item.id == 8) productImage = 'Cheesecake.jpg';
...
// ========================================
// Product Filters (Products Page) - FIXED for dynamic productList
// ========================================
function initProductFilters() {
    ...
    function filterProducts() {
        // Get all product items from the dynamically loaded productList
    ...
    // Also call filter after products are loaded (using MutationObserver)
...
function initPasswordValidation() {
    // NOTE: registerForm and loginForm are handled by register.js and login.js respectively.
    // Only handle passwordForm here (profile page).
    ...
    if (passwordForm) {
        passwordForm.addEventListener('submit', function(e) {
            ...
            // profile.js handles the actual API call via its own listener
        });
    }
}
