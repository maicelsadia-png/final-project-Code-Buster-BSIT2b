    ...
    if (profileForm) {
        profileForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                var response = await fetch('http://localhost:3000/api/users/' + userId, {
                    method: 'PUT',
                    headers: headers,
    ...
    if (passwordForm) {
        passwordForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                var response = await fetch('http://localhost:3000/api/users/' + userId + '/password', {
                    method: 'PUT',
                    headers: headers,
...
async function loadUserProfile(userId) {
    ...
    try {
        ...
        var res = await fetch('http://localhost:3000/api/users/' + userId, { headers: headers });
        if (!res.ok) return;
